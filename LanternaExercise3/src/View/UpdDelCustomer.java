...
public class UpdDelCustomer extends Window{
    ...
    private Component[] line=new Component[5];
    private static GUIScreen guiScreen;

    public UpdDelCustomer(GUIScreen gs) {
    ...
    private void enter(String text) {
        ...
        customerControl ctrl=new customerControl(conn); 
        
        tblCli = new Table(5, "Modify Customer");
        ...
        line[3] = new Label("Update");
        line[4] = new Label("Delete");
        tblCli.addRow(line);
        ...
        for (Customer cust : ctrl.customersList(text)) {
        	
	        line[0] = new Label(cust.getCLID());
	        line[1] = new Label(cust.getName());
	        line[2] = new Label(cust.getSurname());
	        line[3] = new Button("Update", new Action() {	
									@Override
									public void doAction() {
										guiScreen.showWindow(new ModifyCustomer(guiScreen,cust,"A"));            
									}
	        					});
	        line[4] = new Button("Delete", new Action() {
	
						            @Override
						            public void doAction() {
						            	guiScreen.showWindow(new ModifyCustomer(guiScreen,cust,"E"));    
